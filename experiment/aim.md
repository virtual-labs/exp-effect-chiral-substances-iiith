...
Well, as has been explained in the following video using sucrose solution as an example, the specific rotation [¦Á] for a given substance, and hence the molar rotation [¦Õ], varies as a function of the wavelength (¦Ë) of the light source.This variation in the optical rotation ([¦Á] or [¦Õ] ) of a substance, with the variation in the wavelength (¦Ë) of light, is known as optical rotatory dispersion (ORD).
