 ...
 (function() {
     ...
     const myQuestions = [{
		...
		c: "Polarized light and ordinary light wave have opposite vibrations in the space .", ///// Write the option 1 inside double quotes
                d: "Polarized light have vibrations at 90o to the ordinary light wave vibrations. ", ///// Write the option 2 inside double quotes", ///// Write the option 1 inside double quotes
		...
		c: "Polarized light wave vibrations confined to more than one plane and plane of polarization is the plane at right angle to the vector along which the light wave vibrates lies.", ///// Write the option 1 inside double quotes
                d: "Polarized light wave vibrations confined to single plane and plane of polarization is the plane at right angle to the vector along which the light wave vibrates lies", ///// Write the option 2 inside double quotes", ///// Write the option 1 inside double quotes
		...
		c: "Wavelength of light used and concentration of substance.", ///// Write the option 1 inside double quotes
                d: "Temperature, wavelength of light used, and length of polarimeter tube. ", ///// Write the option 2 inside double quotes", ///// Write the option 1 inside double quotes
		...
		c: "If the compound is present in (+) form it rotates plane polarized light in clockwise direction and if it is present in (-) form, it rotates plane polarized light in anticlockwise direction with same magnitude.", ///// Write the option 1 inside double quotes
                d: "Both rotates the plane polarized light in same direction with equal magnitude. ", ///// Write the option 2 inside double quotes", ///// Write the option 1 inside double quotes
		...
		c: "+23.1o.", ///// Write the option 1 inside double quotes
                d: "+29.1o. ", ///// Write the option 2 inside double quotes", ///// Write the option 1 inside double quotes
...

       {
		...
		c: "The negative sign indicates that the S enantiomer is the dominant one.", ///// Write the option 1 inside double quotes
                d: "None of the above options are correct. ", ///// Write the option 2 inside double quotes", ///// Write the option 1 inside double quotes
